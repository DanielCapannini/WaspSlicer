...
namespace Slic3r {
    ...
    public:
        ...
        void mm_height(float height);
        void mm_width(float width);

        // Streaming interface, for processing G-codes just generated by WaspSlicer in a pipelined fashion.
    ...
    private:
        ...
        bool process_waspslicer_tags(const std::string_view comment);
