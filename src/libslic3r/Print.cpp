...
bool Print::invalidate_state_by_config_options(const ConfigOptionResolver & /* new_config */, const std::vector<t_config_option_key> &opt_keys)
{
    ...
    for (const t_config_option_key &opt_key : opt_keys) {
        if (steps_gcode.find(opt_key) != steps_gcode.end()) {
            ...
            || opt_key == "preheating_temperature1"
            || opt_key == "layer_preheating1"
            || opt_key == "preheating_temperature2"
            || opt_key == "layer_preheating2"
            || opt_key == "aria_calda"
            || opt_key == "aria_calda1"
            || opt_key == "layer_air1"
            || opt_key == "aria_calda2"
            ...
            || opt_key == "aria_calda3"
            || opt_key == "layer_air3"
            || opt_key == "firecap_temperature"
            || opt_key == "firecap_temperature1"
            || opt_key == "layer_firecap1"
            || opt_key == "firecap_temperature2"
            || opt_key == "layer_firecap2"
            || opt_key == "firecap_temperature3"
            || opt_key == "layer_firecap3"
