...
static std::vector<std::string> s_Preset_filament_options {
    ...
    "temperature", "idle_temperature", "first_layer_temperature", "layer_temperature0", "layer_range_min0", "layer_range_max0", "n_temp_range", "bed_temperature", "first_layer_bed_temperature", "fan_always_on", "cooling", "min_fan_speed",
