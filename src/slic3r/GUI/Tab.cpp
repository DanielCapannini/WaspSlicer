...
void TabPrint::build()
{
    ...
    page = add_options_page(L("Support material"), "support");
        ...
        optgroup->append_single_option_line("raft_start", "");
        ...
        optgroup = page->new_optgroup(L("Options for support material"));
...
const std::vector<std::string> extruder_options = {
    ...
    "retract_layer_change", "wipe", "retract_before_wipe", "filament_retract_before_wipe_mm_w",
