...
void Tab::create_preset_tab()
{
    ...
    m_treectrl->Bind(wxEVT_TREE_SEL_CHANGED, [this](wxTreeEvent&) {
        ...
        // see https://github.com/prusa3d/WaspSlicer/issues/5720
...
void Tab::on_value_change(const std::string& opt_key, const boost::any& value)
{
    ...
    if (m_postpone_update_ui) {
        ...
        // see https://github.com/prusa3d/WaspSlicer/issues/7146
        return;
    }
...
void TabPrint::update()
{
    ...
    // see https://github.com/prusa3d/WaspSlicer/issues/6814
...
{
    // There is a bug related to Ubuntu overlay scrollbars, see https://github.com/prusa3d/WaspSlicer/issues/898 and https://github.com/prusa3d/WaspSlicer/issues/952.
