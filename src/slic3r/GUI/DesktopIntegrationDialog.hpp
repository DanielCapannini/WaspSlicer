...
public:
	...
	// returns true if path to WaspSlicer.desktop is stored in App Config and existence of desktop file. 
	...
	// Creates Desktop files and icons for both WaspSlicer and GcodeViewer.
